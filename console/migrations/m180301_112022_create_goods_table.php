 ...
 */
class m180301_112022_create_goods_table extends Migration
{
    /**
     * {@inheritdoc}
     */
...
//shop_price	decimal(10, 2)	商品价格
            'shop_price'=>$this->decimal(10,2)->comment('商场价格'),
//stock	int	库存
            'stock'=>$this->integer()->comment('库存'),
//is_on_sale	int(1)	是否在售(1在售 0下架)
            'is_on_sale'=>$this->integer(1)->comment('是否在售 1:在售 0:下架'),
//status	inter(1)	状态(1正常 0回收站)
            'status'=>$this->integer(1)->comment('状态 1:正常 0:回收站'),
//sort	int()	排序
