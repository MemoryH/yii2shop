        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$goods->logo?>" width="350px" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$goods->logo?>',largeimage: '<?=$goods->logo?>'}"><img src="<?=$goods->logo?>"></a>
                            </li>
                            <?php foreach ($goods_photo as $photo):?>
                            <li>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="market_price"><span>定价：</span><em>￥<?=$goods->market_price?>.00</em></li>
                    <li class="shop_price"><span>本店价：</span> <strong>￥<?=$goods->shop_price?>.00</strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?=date('Y-m-d',$goods->create_time)?></li>
                    <li class="star"><span>浏览次数：</span> <?=$goods->view_times?> <a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
