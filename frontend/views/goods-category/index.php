...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="<?=\yii\helpers\Url::to(['goods-category/search'])?>" name="serarch" method="get" class="fl">
                    <input type="text" class="txt" value="请输入商品关键字" name="info" /><input type="submit" class="btn" value="搜索" />
                </form>
        ...
        <div class="user fl">
            <dl>
                ...
                <dd>
                    <div class="prompt">
                        您好<?=Yii::$app->user->identity?Yii::$app->user->identity->username:''?>，<?=Yii::$app->user->identity?"":"[<a href='".\yii\helpers\Url::to(['member/login'])."'>登录</a>]"?>
                    </div>
        ...
        <div class="cart fl">
            <dl>
                <dt>
                    <a href="<?=\yii\helpers\Url::to(['goods/cart-index'])?>">去购物车结算</a>
                    <b></b>
                </dt>
                <dd>
                    <div class="prompt">
    ...
    <div class="nav w1210 bc mt10">
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    ...
                    <div class="cat_detail">
                        <?php $child_category =  \backend\models\GoodsCategory::find()->where(['parent_id'=>$category->id])->all()?>

                        <?php foreach ($child_category as $child):?>
                        <dl class="dl_1st">
                            <dt><a href="<?=\yii\helpers\Url::to(['list/index','id'=>$child->id])?>"><?=$child->name?></a></dt>
                            <?php $child_child_category = \backend\models\GoodsCategory::find()->where(['parent_id'=>$child->id])->all()?>

                                <?php foreach ($child_child_category as $child_child):?>
                            <dd>
                                <a href="<?=\yii\helpers\Url::to(['list/index','id'=>$child_child->id])?>"><?=$child_child->name?></a>
                            </dd>
                                 <?php endforeach;?>
        ...
        <div class="navitems fl">
            <ul class="fl">
                <li class="current"><a href="<?=\yii\helpers\Url::to(['goods-category/index'])?>">首页</a></li>
                <li><a href="">电脑频道</a></li>
                <li><a href="">家用电器</a></li>
                <li><a href="">品牌大全</a></li>
                <li><a href="">团购</a></li>
